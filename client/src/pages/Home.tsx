...
const landingEngines = [
  { 
    id: 1, name: "Protect", status: "Active", 
    metricLabel: "Threat Score", metricValue: "0.02%", 
    details: "Real-time fraud detection", score: "0.02" 
  },
  { 
    id: 2, name: "Grow", status: "Active", 
    metricLabel: "Accuracy", metricValue: "98.4%", 
    details: "Cash flow forecasting", score: "98.4" 
  },
  { 
    id: 3, name: "Optimize", status: "Active", 
    metricLabel: "Pending Savings", metricValue: "$408/yr", 
    details: "Automated execution", score: "408" 
  },
] as const;
    ...
    <div className="min-h-screen bg-slate-950 text-white font-body selection:bg-cyan-500/30 selection:text-cyan-200 overflow-x-hidden">
      ...
      <nav className="relative z-10 max-w-7xl mx-auto px-6 py-6 flex justify-between items-center">
        <div className="flex items-center gap-2 font-display font-bold text-2xl tracking-tighter">
          <div className="w-8 h-8 bg-gradient-to-br from-cyan-400 to-blue-600 rounded-lg flex items-center justify-center text-sm">
            F
          </div>
          FIS.ai
        </div>
        <div className="flex gap-6">
          <Link href="/login" className="text-slate-400 hover:text-white transition-colors text-sm font-medium px-4 py-2">Log In</Link>
          <Link href="/dashboard" className="bg-white text-slate-950 px-5 py-2 rounded-full font-bold text-sm hover:bg-cyan-50 transition-colors flex items-center gap-2">
      ...
      <main className="relative z-10 pt-20 pb-32">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="max-w-3xl mb-24">
            ...
            >
              The first autonomous finance platform that protects, grows, and optimizes your wealth 24/7 with military-grade precision.
            </motion.p>
            ...
            >
              <Link href="/dashboard" className="px-8 py-4 rounded-xl bg-gradient-to-r from-cyan-600 to-blue-600 text-white font-bold text-lg hover:shadow-lg hover:shadow-cyan-500/25 transition-all flex items-center justify-center gap-2 group">
                Command Center <ChevronRight size={20} className="group-hover:translate-x-1 transition-transform" />
              </Link>
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-32">
            {landingEngines.map((engine, i) => (
              ...
              >
                {/* @ts-ignore - mapping compatible mock to proper type for display only */}
          ...
          <div className="border-t border-slate-800 pt-16">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-12">
              {[
                ...
                <div key={stat.label}>
                  <div className={`text-4xl font-display font-bold mb-2 ${stat.color}`}>{stat.value}</div>
